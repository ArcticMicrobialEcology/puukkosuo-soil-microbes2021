...
# all relevant together for grazing
{
  ...
  boxplot(vals~g, col=c("forestgreen", "tan1"), xlab = "", ylim = r_boxplot, ylab = "Relative abundance (%)", main = main_text, cex.main = 1.5, cex.axis = 1.4, cex.lab = 1.5, outline = F, frame = FALSE)
