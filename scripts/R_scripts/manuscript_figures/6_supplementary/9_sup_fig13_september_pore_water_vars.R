# a small script to plot all the pore water variables in September
...
for(i in 5:11){
  ...
  boxplot(vals ~ g, ylab = ylab, xlab = "", las = 2, main = colnames(pore_water_september)[i], col = c(col_ungrazed, col_grazed), ylim = r_boxplot, names=c("Ungrazed downslope", "Grazed upslope"),outline = F, cex.main = 1.5, cex.axis = 1.4, cex.lab = 1.5, frame = FALSE)
