...
{
  pdf(file ="snow_addition_KEGG_MG.pdf", width = 10, height = 5.75, onefile = T)
  par(mar=c(6.1, 35.1, 4.1, 2.1))
  barplot(sig_fgsea$padj, horiz = TRUE, names.arg = gsub("_", " ", sig_fgsea$pathway), las=1, xlim = c(0, 0.12), col = cols_use, xlab = "Adjusted P-value")
  abline(v = 0.1, lwd=2)
  abline(v = 0.05, lwd=2, lty=2)
...
{
  pdf(file ="snow_removal_KEGG_MG.pdf", width = 10, height = 4.65, onefile = T)
  par(mar=c(6.1, 35.1, 4.1, 2.1))
  barplot(sig_fgsea$padj, horiz = TRUE, names.arg = gsub("_", " ", sig_fgsea$pathway), las=1, xlim = c(0, 0.12), col = cols_use, xlab = "Adjusted P-value")
  abline(v = 0.1, lwd=2)
  abline(v = 0.05, lwd=2, lty=2)
...
{
  pdf(file ="grazing_KEGG_MT.pdf", width = 10, height = 5.75, onefile = T)
  par(mar=c(6.1, 35.1, 4.1, 2.1))
  barplot(sig_fgsea$padj, horiz = TRUE, names.arg = gsub("_", " ", sig_fgsea$pathway), las=1, xlim = c(0, 0.12), col = cols_use, xlab = "Adjusted P-value")
  abline(v = 0.1, lwd=2)
  abline(v = 0.05, lwd=2, lty=2)
...
{
  pdf(file ="snow_addition_KEGG_MT.pdf", width = 10, height = 4.1, onefile = T)
  par(mar=c(6.1, 35.1, 4.1, 2.1))
  barplot(sig_fgsea$padj, horiz = TRUE, names.arg = gsub("_", " ", sig_fgsea$pathway), las=1, xlim = c(0, 0.12), col = cols_use, xlab = "Adjusted P-value")
  abline(v = 0.1, lwd=2)
  abline(v = 0.05, lwd=2, lty=2)
...
{
  pdf(file ="snow_removal_KEGG_MT.pdf", width = 10, height = 2.48, onefile = T)
  par(mar=c(6.1, 35.1, 4.1, 2.1))
  barplot(sig_fgsea$padj, horiz = TRUE, names.arg = gsub("_", " ", sig_fgsea$pathway), las=1, xlim = c(0, 0.12), col = cols_use, xlab = "Adjusted P-value")
  abline(v = 0.1, lwd=2)
  abline(v = 0.05, lwd=2, lty=2)
