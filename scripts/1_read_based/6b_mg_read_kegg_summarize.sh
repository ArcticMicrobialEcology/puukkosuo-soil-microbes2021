...
Rscript "$r_script_dir/2b_READ_summarize_KEGG_aligment.R" "$mg_main_dir/kegg_diamond/sample_details" "$mg_main_dir/kegg_diamond/combined_hits_gene_aggregated" "$mg_main_dir/kegg_diamond"
echo "*******************************************************"
echo "*******************************************************"
